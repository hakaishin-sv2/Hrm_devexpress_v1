...
{
    public partial class ReportPhieuLuongNhanVien : DevExpress.XtraReports.UI.XtraReport
    {
        private List<TinhluongDTO> _listData;
        public ReportPhieuLuongNhanVien(System.Collections.Generic.List<BusinessLayer.Convert_DTO.TinhluongDTO> _tinhLuongList)
        {
            InitializeComponent();
            this._listData = _tinhLuongList;
