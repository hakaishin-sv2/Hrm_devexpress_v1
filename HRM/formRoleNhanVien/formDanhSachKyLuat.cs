...
{
    public partial class formDanhSachKyLuat : DevExpress.XtraEditors.XtraForm
    {
        public formDanhSachKyLuat()
        {
            InitializeComponent();
        }
        ...
        void loadData()
        {
            ...
            var list = _khenThuong.getListDTO_ROLE_NHANVIEN(0, thang, nam);
        ...
        private void formDanhSachKyLuat_Load(object sender, EventArgs e)
        {
